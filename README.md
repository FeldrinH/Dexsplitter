...
You can download the splits for the Any% category [here](https://github.com/FeldrinH/Dexsplitter/blob/main/LiveSplit/Ambidextro%20-%20Any%25.lss) (click the download button in the top right corner). The autosplitter will be automatically downloaded and installed when opening the splits in LiveSplit. You can enable it by opening the 'Edit Splits' window and clicking the button labeled 'Activate'.
